    ...
    fetch('/api/certifications')
      ...
      .then(data => {
        if (data.length > 0) {
          ...
          // If empty array, it might be due to seeder not run but DB connected, or fallback used
          setApiError(false);
        }
      })
      .catch(() => {
      ...
      <div className={styles.certContainer}>
        ...
        {apiError ? (
          <div className={styles.apiOfflineMessage}>
            ...
            <span className={styles.errorTitle}>[ SYSTEM LINK ERROR: OFFLINE CREDENTIALS TELEMETRY ]</span>
