...
const roles = ["FRONT END DEVELOPER", "MERN STACK DEVELOPER", "UI CREATOR" , "FULL STACK DEVELOPER"];
...
const Hero = () => {
  ...
  return (
    <section id="hero" className={styles.heroContainer}>
      ...
      <video
        ref={videoRef}
        className={`${styles.videoBackground} ${isVideoPlaying ? styles.videoPlaying : ''}`}
        playsInline
        preload="auto"
        onEnded={() => {
      ...
      {/* Interactive Content */}
      <motion.div
        className={`${styles.heroContent} ${styles.contentActive}`}
      ...
      >
        ...
        <motion.p variants={itemVariants} className={styles.description}>
          Passionate developer creating scalable, modern and visually stunning applications that push the boundaries of design and logic.
        </motion.p>
        ...
        <motion.div variants={itemVariants} className={styles.socials}>
          <a href="https://github.com/ega-ajith" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="Github">
            ...
            <span className={styles.socialLabel}>github.com/ega-ajith</span>
          </a>
          <a href="mailto:ajith@example.com" className={styles.socialIcon} aria-label="Email">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
              <rect width="20" height="16" x="2" y="4" rx="2"/>
              <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/>
            </svg>
            <span className={styles.socialLabel}>ajith@example.com</span>
          </a>
          <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="WhatsApp">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
            ...
            <span className={styles.socialLabel}>+91 98765 43210</span>
          </a>
        </motion.div>
      </motion.div>

      {/* Floating Video Play/Pause Toggle on the Side */}
      <button
        className={`${styles.videoToggleBtn} interactive`}
        onClick={toggleVideoPlay}
        aria-label={isVideoPlaying ? "Pause Video" : "Play Video"}
      >
        {isVideoPlaying ? <Pause size={20} /> : <Play size={20} fill="currentColor" />}
      </button>
    </section>
  );
};
